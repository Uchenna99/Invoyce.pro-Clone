...
const AddClientForm = ({ close }:Props) => {
        ...
        <div className="w-full flex justify-center p-5 fixed z-100 left-0 top-1/2 right-1/2 -translate-y-1/2">
            ...
            <motion.div className="w-full sm:w-[448px] bg-white rounded-lg p-5 flex flex-col gap-3 relative 
                ...
                <div className="flex items-center gap-2">
                    ...
                    <p className="text-lg font-semibold text-text-black">Add New Client</p>
                </div>

                <div className="w-full flex flex-col gap-4 py-3 border-b border-border">

                    <div className="flex flex-col gap-[6px] w-full">
                        <label htmlFor="1" className="text-sm font-medium flex gap-2">Client name <span className="text-error1">*</span></label>
                        <div className="flex items-center relative">
                            <Building2 size={16} color="#99a1af" className="absolute left-3"/>
                            <input type="text" id="1" placeholder="Acme Corporation" 
                                value={clientName}
