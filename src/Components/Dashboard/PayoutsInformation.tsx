...
const PayoutsInformation = () => {
  return (
    <>
        <div className="w-full border border-border rounded-xl shadow shadow-shadow pl-6 pr-8 py-5 flex flex-col gap-6">
            ...
            <div className="w-full border border-border rounded-xl p-6">
