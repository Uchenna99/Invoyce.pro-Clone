...
const HomePage = () => {
  return (
    <>
      <div className="w-full h-fit lg:aspect-[3/1.85] xl:w-[1275px] flex max-lg:flex-col items-center justify-between gap-8 
        ...
        <div className="w-full lg:w-[520px] lg:min-w-[480px] h-fit flex flex-col gap-4">
          ...
          <motion.div className="w-full h-fit flex flex-col gap-4"
            initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.4, ease:'easeInOut'}} >
            <TextBox
              texts="New: 1% Transaction Fee Model"
            />

            <h2 className="text-4xl md:text-5xl text-[#0a0a0a] font-bold md:leading-15 mb-2 mt-1">
          ...
          <motion.div className="w-full h-fit flex"
            initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.4, delay:0.1, ease:'easeInOut'}} >
          ...
          <motion.div className="w-full h-fit flex"
            initial={{opacity:0, y:15}} animate={{opacity:1, y:0}} transition={{duration:0.4, delay:0.2, ease:'easeInOut'}} >
          ...
          <motion.div className="w-full flex max-sm:flex-col gap-4 mt-2"
            initial={{opacity:0, y:15}} animate={{opacity:1, y:0}} transition={{duration:0.4, delay:0.3, ease:'easeInOut'}} >
        ...
        <motion.div className="w-[360px] min-w-[280px] lg:w-[600px] aspect-square bg-cover bg-right"
          initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.8, ease:'easeInOut'}} >
